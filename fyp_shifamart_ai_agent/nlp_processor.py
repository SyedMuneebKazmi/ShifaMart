...
class SymptomNLPProcessor:
    ...
    SYMPTOM_SYNONYMS = {
        ...
        # Dental / oral (combined_dataset uses symptom name `toothache`)
        'toothache': [
            'tooth pain', 'teeth pain', 'toothache', 'tooth ache', 'aching tooth', 'aching teeth',
            'pain in tooth', 'pain in teeth', 'pain in my tooth', 'pain in my teeth',
            'dental pain', 'gum pain', 'sore tooth', 'sore teeth', 'hurts my tooth', 'hurts my teeth',
            'molar pain', 'molars hurt', 'wisdom tooth', 'wisdom tooth pain', 'broken tooth',
            'sensitive teeth', 'tooth sensitivity', 'jaw pain near tooth', 'oral pain',
        ],
        
        # Ear (combined_dataset uses `ear_pain`)
        'ear_pain': [
            'ear pain', 'earache', 'ear ache', 'aching ear', 'pain in ear', 'pain in my ear',
            'ears hurt', 'my ear hurts', 'hurts my ear', 'sore ear', 'throbbing ear',
        ],
        ...
        'insomnia': [
            'insomnia', 'cannot sleep', 'can not sleep', 'cant sleep', 'trouble sleeping', 'not sleeping',
            'sleepless', 'cannot fall asleep', 'unable to sleep', 'poor sleep', 'sleep problems',
            'keeps me awake', 'wide awake at night',
        ],
